...
}, getButtonVariantProp("colorHover"), getButtonVariantProp("colorHover"), getButtonVariantProp("backgroundActive"), getButtonVariantProp("boxShadowActive"), getDisabledStyles, removePointerEvents, styledSystem.space);
...
var NavDesktop = function (props) {
    ...
    return (React__default['default'].createElement(NavWrapper, null, links.map(function (entry) {
        return (React__default['default'].createElement(NavDesktopItem, { key: entry.label },
...
var WalletCard = function (_a) {
    ...
    return (React__default['default'].createElement(Button, { fullWidth: true, variant: "tertiaryDark", onClick: function () {
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(Button, { size: "md", rounded: true, variant: "primary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React__default['default'].createElement(Button, { size: "md", rounded: true, onClick: function () {
...
styled__default['default'](Overlay)(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"], ["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var Menu = function (_a) {
    ...
    var _b = React.useState(!isMobile), isPushed = _b[0]; _b[1];
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(StyledHeader, null,
            React__default['default'].createElement(LeftRight, null,
                React__default['default'].createElement(Logo, null,
                    React__default['default'].createElement(Link, { href: "/" },
                        React__default['default'].createElement("img", { src: "/images/logo.svg", width: "170px", alt: "Lightening Cash Logo" }))),
                React__default['default'].createElement(NavDesktop, { isPushed: isPushed, links: links })),
            React__default['default'].createElement(LeftRight, null,
...
var Footer = function (_a) { return (React__default['default'].createElement(React__default['default'].Fragment, null,
    ...
    React__default['default'].createElement(FooterSocial, null,
        React__default['default'].createElement(SocialItem, { href: "https://twitter.com/CashLightening" },
            React__default['default'].createElement(reactFontawesome.FontAwesomeIcon, { icon: freeBrandsSvgIcons.faTwitter, size: "lg" })),
        React__default['default'].createElement(SocialItem, { href: "https://t.me/lighteningcash" },
            React__default['default'].createElement(reactFontawesome.FontAwesomeIcon, { icon: freeBrandsSvgIcons.faTelegram, size: "lg" })),
        React__default['default'].createElement(SocialItem, { href: "https://lightening-cash.medium.com/" },
